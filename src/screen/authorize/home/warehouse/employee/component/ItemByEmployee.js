...
import {ListViewOrder} from './ListViewOrderEmployee';
...
import {getListOrderByEmployee} from '../redux/EmployeeApi';
import {getOrderEmpId} from '../redux/EmployeeSlice';

export function ItemByEmployee({navigation, route}) {
  ...
  useEffect(() => {
    dispatch(getListOrderByEmployee(idEmployee));
  }, [IsFocused, dispatch, idEmployee]);
