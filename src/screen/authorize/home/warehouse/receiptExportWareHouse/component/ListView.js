...
import {Box, HStack, VStack, Spacer, Icon, Button} from 'native-base';
...
import {deleteReceiptImportWareHouseApi} from '../../receiptImportWareHouse/redux/ReceiptImportWareHouseApi';
import {deleteReceiptExportWareHouseApi} from '../redux/ReceiptExportWareHouseApi';
...
const ListViewComponent = ({
  ...
  const _onConfirmDelete = useCallback(payload => {
    if (_swipe.current) {
      ...
      //console.log(payload);
      dispatch(deleteReceiptExportWareHouseApi(payload, onRefresh));
    }
  }, []);
